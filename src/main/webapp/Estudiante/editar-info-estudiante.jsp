<%-- 
    Document   : editar-info-estudiante
    Created on : 18/11/2023, 09:59:34
    Author     : VICTUS
--%>
        ...
        <div>
            ...
            <div id="container">
                ...
                <form id="formulario-disable">
                    <h1 id="titulo">Datos Actuales</h1>
                    <div class="mb-3">
                        <label>Nombre:</label>
                    ...
                    <div class="mb-3">
                        <label>Carne:</label>
                        <input type="text" name="carne" class="form-control" disabled>
                    </div>
                    <div class="mb-3">
